...
local function worker(args)
    ...
    local font = args.font or 'JetBrains Mono Regular 6'
    ...
    local warning_msg_icon = args.warning_msg_icon or HOME .. '/.config/awesome/widgets/spaceman.jpg'
    ...
    -- To use colors from beautiful theme putarc_thickness
